...
class BuildingCacheManager:
    ...
    def ensure_initialised(cls, force: bool = False) -> bool:
        ...
        with cls._lock:
            ...
            try:
                ...
                from buildings_cache import CACHE_POPULATED

                if CACHE_POPULATED and not force:
    ...
    def get_known_buildings(cls) -> List[str]:
        ...
        from buildings_cache import BUILDING_NAMES_CACHE, CACHE_POPULATED
        return list(set(BUILDING_NAMES_CACHE.values())) if CACHE_POPULATED else []

    @classmethod
    def get_alias(cls, canonical_or_alias: str) -> Optional[str]:
        """Get canonical name for an alias."""
        cls.ensure_initialised()
        from buildings_cache import BUILDING_ALIASES_CACHE
        return BUILDING_ALIASES_CACHE.get(canonical_or_alias.lower())
    ...
    def set_populated(cls, value: bool):
        ...
        import buildings_cache
        buildings_cache.CACHE_POPULATED = value
    ...
    def get_cache_stats(cls) -> Dict[str, Any]:
        ...
        return {
            ...
            'canonical_names': len(set(BUILDING_NAMES_CACHE.values())),
            'aliases': len(BUILDING_ALIASES_CACHE),
            'metadata_fields': sum(len(v) for v in METADATA_FIELDS_CACHE.values()),
            'indexes_with_buildings': INDEXES_WITH_BUILDINGS.copy()
        }
...
def clear_building_cache():
    ...
    global _BUILDING_NAMES_CACHE, _BUILDING_ALIASES_CACHE, _METADATA_FIELDS_CACHE, _INDEXES_WITH_BUILDINGS
    _BUILDING_NAMES_CACHE.clear()
    _BUILDING_ALIASES_CACHE.clear()
    _METADATA_FIELDS_CACHE.clear()
    BuildingCacheManager.set_populated(False)
...
# ============================================================================
# BUILDING NAME NORMALISATION MOVED TO building_normaliser.py
# ============================================================================
...
def filter_results_by_building(results: List[Dict[str, Any]], target_building: str) -> List[Dict[str, Any]]:
    """
